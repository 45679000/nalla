...
$querynoti = $conn->prepare($sqlnoti);
...
VALUES(:name, :email, :password, :gender, :mobileno, :designation, :image, 1)";
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="well row pt-2x pb-3x bk-light text-center">
                         <form method="post" class="form-horizontal" enctype="multipart/form-data" name="regform" style="background-color: #29abe0 !important; height:100%; padding:20px; color:black;" onSubmit="return validate();">
