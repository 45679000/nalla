...
if(isset($_POST['submit']))
  {
	...
	$sql="UPDATE users SET name=(:name), email=(:email), gender=(:gender), mobile=(:mobileno), designation=(:designation), Image=(:image) WHERE user_id=(:idedit)";
...
<div class="form-group">
	<div class="col-sm-8 col-sm-offset-2">
		...
		<input type="hidden" name="idedit" value="<?php echo htmlentities($result->user_id);?>" >
</div>
</div>
