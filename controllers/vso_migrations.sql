...
INSERT INTO `vs_staff` (`id`, `name`, `position`, `county_id`, `center_id`, `phone_number`,  `active`) 
VALUES 
(786,'CELINA AKAI',2,4,268,'0712118648',1),
...
VALUES 
(786,'0712118648',MD5('ISIOLOEF'),'2','ISIOLOEF',786,'ROSEMINA EYANAE', MD5(CONCAT('0712118648', MD5('ISIOLOEF')));
(787,'0713968833',MD5('ISIOLOEF'),'2','ISIOLOEF',787,'JANET EKURA', MD5(CONCAT('0713968833', MD5('ISIOLOEF')));
