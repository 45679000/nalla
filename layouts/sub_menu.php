                        ...
                        <div class="card">
                            <div class="expanel expanel-primary">
                                    ...
                                    <div class="list-group list-group-transparent mb-0 mail-inbox">
                                            <a href="./tasting_grading.php?view=grading" class="list-group-item list-group-item-action d-flex align-items-center">
                                                <span class="icon mr-3"><i class="fe fe-send"></i></span>Grading
                                            </a>
                                            <a href="./tasting_grading.php?view=offered-teas" class="list-group-item list-group-item-action d-flex align-items-center">
