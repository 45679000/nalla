...
<body>
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Manage <b>Warehouses</b></h2>
						</div>
						<div class="col-xs-6">
							<a href="#addWarehouse" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Warehouse</span></a>
				...
				<table class="table table-striped table-hover">
					...
					<tbody>
                    <?php
                            foreach($warehouse->getWarehouses() as $warehouse){
                                echo '
                                    <tr>
                                        <td>
                                            <span class="custom-checkbox">
	...
	<!-- Edit Modal HTML -->
	<div id="addWarehouse" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method = "post" action="warehouse-view.php">
