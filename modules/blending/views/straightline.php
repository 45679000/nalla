                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <select id="buyer" name="buyer"
                                    class="buyer form-control form-control-cstm select2-show-search well"><small>(required)</small>
                                </select>
                            </div>
                            <div class="col-md-5 form-group">
                                <label class="control-label">Details:</label>
                                <textarea col="10" class="form-control" id="details" name="details"
...
$(document).ready(function() {
    ...
    $("body").on("click", ".addTea", function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $this.parent().text(localStorage.getItem("contractno"));
                viewAllocations();
            }
