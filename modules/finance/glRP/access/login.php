...
function defaultCompany()
{
	...
	$title = $login_timeout ? _('Confirm You can Login') : $SysPrefs->app_title." ".$version." - "._("Login");
	...
	// echo "<table class='titletext'><tr><td>Chamu Finance/td></tr></table>\n";
	...
	if (!$login_timeout) { // FA logo
    	// echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/imagess/logo_frontaccounting.png' alt='Cahmu Accounting' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
		echo "<font size=5>"._('You were Login session Expired ')."</font>";
	} 
	echo "</td>\n";
	end_row();
	...
	echo "<input type='hidden' name='user_name_entry_field' value='admin'>";
	// text_row(_("User name"), "user_name_entry_field", "admin", 20, 30);
	echo "<input type='hidden' name='password' value='admin123#'>";

	echo "<input type='hidden' name='company_login_name' value='0'>";
	...
	echo "<center><input type='submit' value='&nbsp;&nbsp;"._("Click here to confirm access ")."&nbsp;&nbsp;' name='SubmitUser'"
