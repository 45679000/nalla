...
***********************************************************************/
	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			echo "<tr> <td colspan='2' style='padding: 0 0 0 0 ; '>" ;
				...
				// echo "<tr> <td  colspan='3' align='left'><a target='_blank' href='$power_url'><img style='height:50px; width:100px;' src='$path_to_root/themes/". user_theme()."/images/logo_frontaccounting.png' alt='FrontAccounting' onload='fixPNG(this)' border='0' /></a> </td> </tr> ";
				...
				if (!$no_menu)
			{
				...
				echo "<div style='background-color:green;' class=tabs>";
				// echo'<a class="menu_tab" href="./index.php?" accesskey="P"><u>Link Name</a>';
	...
	echo "<tr>\n";
	echo "<td style='text-align: left; ' ><a target='_blank' href='$power_url' tabindex='-1'>$app_title $version  </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='http:kvcodes.com/'>" . _("Theme:") . " " . user_theme() . "</a>\n";
	//echo "</tr>\n";
	//echo "<tr>\n";
