...
echo'<ul id="tabs" >
<li><a href="#" name="#tab1">Customer</a></li>
<li><a href="#" name="#tab2">Sales</a></li>
<li><a href="#" name="#tab3">Suppliers</a></li>
<li><a href="#" name="#tab4">Items</a></li>
<li><a href="#" name="#tab5">General</a></li>

</ul>
<div id="content" >


<div id="tab1" style="backgroud-color:green">';
