...
$today = date2sql(Today());
 ...
 function get_total_reorder($today)
 {
		
			$sql2 = "select COUNT(".TB_PREF."stock_moves.stock_id) AS Rcount
...
//var_dump(get_total_reorder($today));
             ...
             echo ' <!-- Notifications: style can be found in dropdown.less -->
              ...
              <li class="dropdown tasks-menu">
                <a href="#" class="dropdown-toggle" style="height:50px;" data-toggle="dropdown">
                  ...
                  <span class="label label-danger">'.get_total_reorder($today).'</span>
                </a>
                <ul class="dropdown-menu">
