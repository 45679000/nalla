    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 col-lg-12 text-center">
            <div class="card px-4 pt-4 pb-0 mt-3 mb-3 p-4 mt-3 mb-2">
                <h2 id="heading">Create Commercial Invoice Blend</h2>
...
<script>
    $(document).ready(function() {
        $("#page1Btn").hide();
        $("#invoicePreview").html('<iframe class="frame" frameBorder="0" src="../../../reports/invoice_commercial_blend.php?invoiceno='+localStorage.getItem("invoiceno")+'" width="1000px" height="800px"></iframe>');
