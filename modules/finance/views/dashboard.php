...
$("#prvtPurchases").click(function(e) {
    window.location.href = "/nalla/modules/stock/index.php?view=ppurchases";
});

$("#missingLots").click(function(e) {
    window.location.href = "/nalla/views/view_valuations.php";

});
$("#banking_gl").click(function(e) {
    $("#dashboardWrapper").html('<iframe src="/nalla/modules/finance/glRP/index.php?application=GL" width="100%" height="1000" style="border:none;">');
});
$("#purchasesOthers").click(function(e) {
    $("#dashboardWrapper").html('<iframe src="/nalla/modules/finance/glRP/index.php?application=AP" width="100%" height="1000" style="border:none;">');
});
$("#customers").click(function(e) {
    $("#dashboardWrapper").html('<iframe src="/nalla/modules/finance/glRP/sales/manage/customers.php" width="100%" height="1000" style="border:none;">');
});
$("#suppliers").click(function(e) {
    $("#dashboardWrapper").html('<iframe src="/nalla/modules/finance/glRP/purchasing/manage/suppliers.php" width="100%" height="1000" style="border:none;">');
});
