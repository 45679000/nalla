                            ...
                            <div class="tab-menu-heading">
                                <div class="tabs-menu ">
                                    ...
                                    <ul class="nav panel-tabs">
                                        <li id="create-profoma" class=""><a href="#tab1" class="active"
                                                data-toggle="tab">Create Profoma Invoice</a></li>
                                        <li id="allocate-teas"><a href="#tab2" data-toggle="tab">Allocate Lots</a></li>
