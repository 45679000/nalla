		    ...
		    <div class="card">
                <div class="card-header">
                   <i id="helpBlend" style="float:left; font-size:large" class="fa fa-question-circle">help</i>
                    ...
                    <span class="label label-info">Click Create an invoice,  
                        <i class="fa fa-plus btn-success"></i>  to add lots to invoice <i class="fa fa-pencil btn-success"></i> 
                         to edit a blend and <i class="fa fa-trash btn-danger"></i>  to delete an invoice</span>
                    </div>
                    <div class="card-options">
                    <button type="button" class="btn btn-success m-1 float-left toolbar-button" data-toggle="modal" data-target="#addModal">
                    <i class="fa fa-plus"></i> Create invoice</button>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 well">
                            <div class="form-group label-floating">
                                ...
                                <select id="invoice_category" name="invoice_category" class="form-control form-control-cstm select2-show-search well"><small>(required)</small>
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input id="invoice_type" type="text" class="form-control" name="invoice_type" placeholder="Invoice Type" required="" >
                        </div>
                   
                        <div class="col-md-3 form-group">
                            <label class="control-label">Buyer:</label>
                                <select id="buyer" name="buyer" class="form-control form-control-cstm select2-show-search well"><small>(required)</small>
                              </select>
                        </div>   
                    </div>
                    <div class="row">
                        <div class="col-md-3 form-group">
                            ...
                            <select id="payment_terms" name="payment_terms" class="form-control form-control-cstm select2-show-search well"><small>(required)</small>
                              </select>
                        </div>
                        <div class="col-md-3 form-group">
                            <label class="control-label">Buyer Bank:</label>
                            <input type="text" class="form-control" name="buyer_bank" placeholder="Buyer Bank" required="">
                        </div>  
                        <div class="col-md-3 form-group">
                            <label class="control-label" for="port_of_delivery">Port Of Delivery:</label>
                            <textarea name="port_of_delivery" id="port_of_delivery" cols="17" rows="2"></textarea>
                        </div>
                        <div class="col-md-3 form-group">
                            <label class="control-label" for="consignee">Consignee:</label>
                            <textarea name="consignee" id="consignee" cols="17" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 form-group">
                            <label class="control-label" for="pay_bank">Payment Bank:</label>
                            <textarea name="pay_bank" id="pay_bank" cols="17" rows="2"></textarea>
                        </div>
                        <div class="col-md-3 form-group">
                            <label class="control-label" for="name">Payment Details:</label>
                            <textarea name="pay_details" id="pay_details" cols="17" rows="2"></textarea>
                        </div>
