    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 col-lg-12 text-center">
            <div class="card px-4 pt-4 pb-0 mt-3 mb-3 p-4 mt-3 mb-2">
                <h2 id="heading">Create Profoma Invoice Blended Tea</h2>
                <p>Fill all form field to go to next step</p>
                <form id="msform" class="p-1">
                    <!-- progressbar -->
                    <ul id="progressbar">
                        <li class="active" id="account"><strong>Invoice Details</strong></li>
                        <li id="personal"><strong>Blend Line</strong></li>
                        ...
                        <div class="form-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" class="form-control" id="hs_code" name="hs_code" placeholder="HS CODE" required="">
                                </div>
                                <div class="col-md-3 form-group">
