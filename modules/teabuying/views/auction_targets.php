                        ...
                        <div class="card-body">
                            <div class="card-header">
                                <div class="card-options">
                                    <button id="buying_list" class="btn btn-info btn-sm"><i class="fa fa-file"></i>Preview Buying List</button>
                                    <button id="go_back" class="btn btn-beige btn-sm"><i class="fa fa-reply"></i>Go Back</button>
...
$("#buying_list").click(function(){
    ...
    $("#go_back").show();
    $("#buying_list").hide();
    $("#gradingTable").html('<iframe class="frame" frameBorder="0" src="../../reports/auction_list.php?saleno='+saleno+'&broker='+broker+' &category='+category+'&filter=true" width="100%" height="800px"></iframe>');
