                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 col-md-3">
                            ...
                            <div class="form-group"><label class="form-label">Broker</label><select name="broker"
                                    id="broker" class="form-control  select2" data-placeholder="Select)">
                                </select>
                            </div>
                            <div class="form-group"><label class="form-label">Sale Type</label>
                                <select name="category"
                                    id="category" class="form-control  select2" data-placeholder="Select)">
                            ...
                            <input type="text" class="form-control" id="invoice" name="invoice" value="" required></div>
                        </div>
                        <div class="col-md-3 col-md-3">
                            <div class="form-group"><label class="form-label">Garden</label><select name="mark"
                                    id="mark" class="form-control  select2" data-placeholder="Select)">

                                </select>
                            </div>
                            <div class="form-group"><label class="form-label">Lot No</label><input type="text"
                                    class="form-control" id="lot" name="lot" value="" required></div>
                            <div class="form-group"><label class="form-label">Grade</label><select name="grade"
                                    id="grade" class="form-control  select2" data-placeholder="Select)">
                                </select>
                            </div>
                            <div class="form-group"><label class="form-label">Gross</label><input type="text"
                                    class="form-control" id="gross" name="gross" value=""></div>
                        </div>
                        <div class="col-md-3 col-md-3">
                        ...
                        <div class="col-md-3 col-md-3">
                            <div class="form-group"><label class="form-label">Value</label><input type="text"
                                    class="form-control" id="value" name="value" value="" required></div>
                            <div class="form-group"><label class="form-label">Pkg Type</label><select name="type"
                                    id="type" class="form-control  select2" data-placeholder="Select)">
                                    Select2 with search box<option value="BPP">BPP</option>
                                    <option value="TPP">TPP</option>
                                    <option value="PB">PB</option>
                                </select>
                            </div>
                            <div class="form-group"><label class="form-label">Ware House</label><input type="text"
                                    class="form-control" id="ware_hse" name="ware_hse" value="" required></div>
