<?php
	...
	function menu_user_management($path_to_root){
		return '
		<li class="nav-item">
			<a class="nav-link" href='.$path_to_root.'admin/index.php?view=dashboard><i class="fa fa-users text-danger font-weight-bold"></i><span class="font-weight-bold">User Management</span></a>
		</li>';
	}
